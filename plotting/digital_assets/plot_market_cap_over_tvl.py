...
if __name__ == "__main__":
    ...
    plotter.plot_line_from_dfs(
        ...
        ylabel=ylabel,
        labels=labels,
        file_name=os.path.join("digital-assets-book", "mkt_cap_tvl_yield_agg.png"),
    ...
    plotter.plot_line_from_dfs(
        ...
        ylabel=ylabel,
        labels=labels,
        file_name=os.path.join("digital-assets-book", "mkt_cap_tvl_plf.png"),
        linestyles=["solid", "dotted"],
        grid=True,
        xticks_rotation=90,
        set_billions=False,
    ...
    plotter.plot_line_from_dfs(
        ...
        grid=True,
        set_billions=False,
        file_name=os.path.join("digital-assets-book", "mkt_cap_tvl_dexs.png"),
    )
