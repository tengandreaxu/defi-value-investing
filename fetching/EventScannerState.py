"""
From: https://web3py.readthedocs.io/en/stable/examples.html?highlight=transfer#advanced-example-fetching-all-token-transfer-events
"""
...
class EventScannerState(ABC):
    ...
    @abstractmethod
    def process_event(self, block_when: datetime, event: AttributeDict) -> object:
